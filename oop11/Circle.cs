    ...
    class Circle
    {
        ...
        public double Radius
        {
            ...
            set
            {
                if (value < 0)
                {
                    Console.WriteLine("Nevernoie znachenie. Radius ne ustanovlen");
                }
                else
                {
                    rad = value;
        ...
        {
            Console.WriteLine("Vsego sozdano " + count + " ekzempliarov classa");
        }
        ...
        {
            return ("Radius = " + this.rad + ", х = " + this.X + ", у = " + this.Y);
        }
    }
}